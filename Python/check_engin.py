# This file put trends into another format, then check the relationship with the articles in database.
...
def check_related(word_list, tags, title):
    ...
    # Check in tag list first, if there is a word appears in tags, consider it
    # as related to it.
